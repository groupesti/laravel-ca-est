...
class EstResponseBuilder
{
    ...
    {
        CaLog::estOperation('build_pkcs7_response', [
            'certificate_count' => count($certPems),
        ]);
    ...
    {
        CaLog::estOperation('build_server_keygen_response', []);
    ...
    {
        CaLog::estOperation('build_csr_attrs', [
