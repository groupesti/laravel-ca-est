...
class EstServer implements EstServerInterface
{
    ...
    {
        CaLog::estOperation('simple_enroll', [
            'ca_id' => $ca->getId(),
    ...
    {
        CaLog::estOperation('simple_reenroll', [
            'ca_id' => $ca->getId(),
    ...
    {
        CaLog::estOperation('server_keygen', [
            'ca_id' => $ca->getId(),
            'client_identity' => $auth['identity'] ?? null,
        ]);
